 ...
 * @{
 */
static const uint32_t WGPU_ARRAY_LAYER_COUNT_UNDEFINED = UINT32_MAX;
static const uint32_t WGPU_COPY_STRIDE_UNDEFINED = UINT32_MAX;
static const uint32_t WGPU_DEPTH_SLICE_UNDEFINED = UINT32_MAX;
static const uint32_t WGPU_LIMIT_U32_UNDEFINED = UINT32_MAX;
static const uint64_t WGPU_LIMIT_U64_UNDEFINED = UINT64_MAX;
static const uint32_t WGPU_MIP_LEVEL_COUNT_UNDEFINED = UINT32_MAX;
static const uint32_t WGPU_QUERY_SET_INDEX_UNDEFINED = UINT32_MAX;
static const size_t WGPU_WHOLE_MAP_SIZE = SIZE_MAX;
static const uint64_t WGPU_WHOLE_SIZE = UINT64_MAX;
